...
# SPARQL-запрос к WikiData: берём ключевые понятия блока «Путь к профессии»
QUERY = """
SELECT ?item ?itemLabel ?description WHERE {
  VALUES ?item {
    wd:Q741939    # профессиональная ориентация
    wd:Q6869278    # профессиональное образование
    wd:Q4439145    # стажировка
    wd:Q967647    # наставничество
  }
...
def convert(data: dict) -> dict:
    ...
    return {
        "project": "Я и будущая профессия: Путь к профессии",
