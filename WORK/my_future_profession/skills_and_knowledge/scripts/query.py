...
# SPARQL-запрос к WikiData: берём ключевые понятия блока «Навыки и знания»
QUERY = """
SELECT ?item ?itemLabel ?description WHERE {
  VALUES ?item {
    wd:Q205961    # умение (навык)
    wd:Q15910354    # гибкие навыки
    wd:Q8434    # образование
    wd:Q467677    # одарённость (талант)
  }
...
def convert(data: dict) -> dict:
    ...
    return {
        "project": "Я и будущая профессия: Навыки и знания",
